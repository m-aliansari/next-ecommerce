        ...
        <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                <div>
                    ...
                    <h2 className="mt-6 text-center text-3xl tracking-tight font-bold text-gray-900">Sign up to an account</h2>
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Or
                        <Link href={'/login'}>
                            <a className="font-medium text-gray-600 hover:text-gray-500"> Login </a>
                        </Link>
                    </p>
                </div>
